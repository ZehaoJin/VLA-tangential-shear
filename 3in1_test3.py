...
for cluster in cluster_list:
    ...
    catalog = fun.supplementary_loadcatalog(catalog,cluster)
    entries_sup = catalog.size
    ...
    print 'sources selected:',entries_full,'->',entries_z,'->',entries_sup,'->',entries_DC,'->',entries_ellipticity,'->',entries_R,'sources'
...
fun.fixed_bins_averaged_tangential_shear('0416+0717+1149',tangential_shear_DC_total,shuffle_time)
